               ...
               <div className="form">
                    <div className="form-group">
                        <Row className="show-grid">
                            ...
                            <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                                <label>Span:</label>
                                <input type="text" onChange={(e) => setSpan(e.target.value)} value={span} className="form-control" placeholder="Enter Span"/>
