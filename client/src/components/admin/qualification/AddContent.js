...
const AddContent = ({addFormState, toggleAddForm, alertNotification}) => {
    ...
    const addNewQualification = () => {
        if(token){
            ...
            Axios.post(url('/api/admin/add-new-qualification'), content).then((response) => {
                ...
                if(data.status === 'input-error'){
                    ...
                    dispatch(AddUserQualification(data.qualification))
                    alertNotification('success', 'Qualification added successfully!')
                            ...
                            <div className="form-button">
                                { 
                                    button ? (
                                        ...
                                        <button onClick={() => addNewQualification()} type="button">ADD QUALIFICATION</button>
                                    )
                                }
